 ...
 * @author admin
 */
public class SelectUserBuys extends javax.swing.JFrame {

    /**
     * Creates new form DeleteCarGUI
     */
    public SelectUserBuys() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Show User's Buys");

        idLabel.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        idLabel.setText("User's ID");

        selectUserIdTextField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                selectUserIdTextFieldActionPerformed(evt);
            }
        });
    ...
    private void selectUserIdTextFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_selectUserIdTextFieldActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelectUserBuys.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SelectUserBuys().setVisible(true);
            }
        });
    }
